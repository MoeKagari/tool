...
public class GifSequenceWriter {
	...
	public GifSequenceWriter(
		...
		this.imageMetaData = this.gifWriter.getDefaultImageMetadata(imageTypeSpecifier,
	...
	public void writeToSequence(RenderedImage img) throws IOException {
		this.gifWriter.writeToSequence(
				new IIOImage(
						img,
						null,
						this.imageMetaData),
	 ...
	 * 
	 * @param rootNode
	 *                the <tt>IIOMetadataNode</tt> to search for the child
	 *                node.
	 * @param nodeName
